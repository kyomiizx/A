...
-- ========================================
-- 3. UPDATE LIST POINT (DENGAN SAFETY CHECK)
-- ========================================
function updateList()
    ...
    if not listFrame then 
        print("⚠️ ListFrame tidak ditemukan!")
        return 
    end
    
    -- Hapus semua tombol lama (kecuali header)
    ...
    for _, name in ipairs(sortedNames) do
        ...
        -- Double click / Right click = langsung teleport
    ...
    local scrollFrame = listFrame.Parent
...
local function createUI()
    ...
    print("✅ UI TP System V3 siap!")
end

-- ========================================
-- 5. JALANKAN UI (DENGAN DELAY)
-- ========================================
-- Beri jeda sedikit agar karakter dan GUI siap
task.wait(0.5)
createUI()
...
-- ========================================
game.StarterGui:SetCore("SendNotification", {
    Title = "🚀 TP System V3 Aktif!",
    Text = "📌 F1=Set Point | F2=TP Point | F3=Toggle GUI",
    Duration = 4,
})

print("✅ TP System V3 siap digunakan!")
